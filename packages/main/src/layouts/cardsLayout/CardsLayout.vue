...
import { topBarHeight, gutter } from '@/configs/layoutConfig';

onBeforeMount(() => {
  document.documentElement.style.setProperty('--top-row-height-with-gutter', `${topBarHeight + gutter}px`);
});
...
.cards-container {
  width: 100%;
  height: 100%;
  padding-top: var(--top-row-height-with-gutter);
  pointer-events: none;
}
